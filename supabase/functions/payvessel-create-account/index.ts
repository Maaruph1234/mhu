...
// history. This one was already dead before the removal (wallet funding
...
// delete by hand, and `supabase functions delete payvessel-create-account`
// to drop the deployed copy.
