...
//   Electricity/TV success: billersCode 1111111111111 (prepaid) or
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (service === "data") {
      ...
      payBody.variation_code = body.variationCode;
      // "renew" keeps the customer's current bouquet; use "change" instead
      // if you add bouquet-switching as a distinct flow later.
      payBody.subscription_type = "renew";
